...
<body>
    <?php
        ...
        */
        ...
        $klasa_2m = '[{"imie":"Adam","ocena":"4,5"},{"imie":"Robert","ocena":"4"}]';   
        var_dump(json_decode($klasa_2m));
        echo"<br><br>";

        $klasa_2m2 = "Adam,4.5|Marek,5|Jola,5|Robert,4|Kasia,4";
        $klasa_2m3 = "Adam,4.5|Marek,5|Jola,5|Robert,4|Kasia,4";
        function decode($dane){
        $r = [];
        $e = explode("|",$dane); //rozbicie stringa
        foreach($e as $k){
            $u = explode(",",$k); //rozbicie stringa
            $r[] = ['imie' => $u[0], 'ocena' => $u[1]];
        }
        return $r;
        }
        $klasa1=decode($klasa_2m2);
        var_dump($klasa1);
        echo"<br><br>";
        $klasa2=decode($klasa_2m3);
        var_dump($klasa2);
        echo"<br><br>";

        $klasy = ['1a' => $klasa1,'1b' => $klasa2];
        var_dump($klasy);
    ?>
</body>
</html>